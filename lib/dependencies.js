...
Dependencies.prototype.count = function count() { return _.size(this._deps) };
Dependencies.prototype.names = function names() { return _.keys(this._deps) };
Dependencies.prototype.each = function each(iterator) { _.each(this._deps, iterator) };
Dependencies.prototype.contains = function contains(id) { return this._deps.hasOwnProperty(id) };

Dependencies.prototype.cwd = function cwd(path) {/* currently a no-op */ };
